          ...
          <div className="flex flex-wrap mb-24 -mx-4">
            <div className="w-full px-4 mb-8 md:w-1/2 md:mb-0">
              <div className="">
                <div className="">
                  <img
                    className=" h-52 lg:h-fit rounded-lg"
                    src="https://rukminim2.flixcart.com/image/412/412/xif0q/face-wash/7/9/0/200-neem-tea-tree-face-wash-acne-control-aroma-magic-original-imaghexzapbye9fd.jpeg?q=70"
                    alt=""
                  />
                </div>
              </div>
              ...
              <div className="lg:pl-20">
                ...
                <div className="mb-6">
                  ...
                  <p>
                    ...
                    delectus nemo dolorum officia esse beatae opte
                  </p>
                </div>
